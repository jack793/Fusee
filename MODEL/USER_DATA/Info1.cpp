...
//COSTRUTTORE
Info1::Info1(const QString& n, const QString& c, const bool s, const QDate& d, cons):
    nome(n), cognome(c), sesso(s), dataNascita(d) {}

//GET
Info1::Info1(const QString &n, const QString &c, const bool s, const QDate &d, const QString &p) {}
...
void Info1::setPaese(const QString &p) {paese=p;}
...
Info1 Info1::readInfo1(QXmlStreamReader& xmlReader){
    ...
    return (Info1(nome,cognome,sesso,date));
}
